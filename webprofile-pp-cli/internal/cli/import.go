...
but do not stop the import.`,
  ...
  webprofile-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  webprofile-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | webprofile-pp-cli import <resource> --input -`,
