...
but do not stop the import.`,
  ...
  freightindex-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  freightindex-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | freightindex-pp-cli import <resource> --input -`,
