...
but do not stop the import.`,
  ...
  schedule-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  schedule-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | schedule-pp-cli import <resource> --input -`,
