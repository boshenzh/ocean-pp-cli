...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "schedule-pp-cli",
		Short: `Discovers carriers, fleet routes, and weekly sailings for ocean-freight forwarders; combines Weiyun's public port/carrier APIs with user-registered routePort URLs.`,
		Long: `Discovers carriers, fleet routes, and weekly sailings for ocean-freight forwarders; combines Weiyun's public port/carrier APIs with user-registered routePort URLs.
...
Run 'schedule-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("schedule-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'schedule-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCarrierServicesPromotedCmd(flags))
	rootCmd.AddCommand(newCarriersPromotedCmd(flags))
	rootCmd.AddCommand(newFleetRoutesPromotedCmd(flags))
	rootCmd.AddCommand(newPortsPromotedCmd(flags))
